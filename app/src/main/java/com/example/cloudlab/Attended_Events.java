                ...
                if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
                    ...
                    if (s_name.isEmpty() || s_rollno.isEmpty() || s_email.isEmpty() || t_name.isEmpty() || c_name.isEmpty() || s_dept.equals("-Department-") || p_title.isEmpty() || c_mode.equals("-Contest Mode-") || s_prize.equals("-Prize Won-")) {
                        ...
                        if (t_name.isEmpty())
                            ...
                            tname.setError("DOC ID contains 5 digits");
                        if (p_title.isEmpty())
...
//System.out.println("ooutput"+c_name+t_name+p_title+s_name+s_rollno+s_email);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbxRiF3antLV7aOq_qhybsu0mtkKQFip4EzVRi6mlmcV1rRwwNpZhmRl1QsH6V2l3adg/exec",
...
System.out.println("ooutput3 : "+e_date);
                //here we pass params
                parmas.put("action","reward_points");
                parmas.put("s_name",s_name);
                parmas.put("s_email",s_email);
                parmas.put("s_rollno",s_rollno);
                parmas.put("t_name",t_name);
                parmas.put("s_dept",s_dept);
                parmas.put("c_name",c_name);
                parmas.put("p_title",p_title);
                parmas.put("s_date",s_date);
                parmas.put("e_date",e_date);
                parmas.put("c_mode",c_mode);
                parmas.put("s_prize",s_prize);
                return parmas;
            }
        };
